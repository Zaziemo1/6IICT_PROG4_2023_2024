...
weer_data['waarschuwingen'] = ["Hitteadvies", "Smog-gevaar", "tropische bui"],
...
"""
for voorspellingen in weer_data["voorspelling"]:
    print(f" - {voorspellingen}:  {weer_data['voorspelling'][voorspellingen]['hoge_temp']}")
