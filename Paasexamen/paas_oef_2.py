...
class Fruit:
    def __init__(self, breedte_scherm:int, hoogte_scherm:int, kleur:tuple): # (  / 2)
        ...
        self.straal = random.uniform(0.01,0.05)*breedte_scherm
        self.snelheid = random.uniform(0.005,0.02)*breedte_scherm
        self.kleur = kleur
...
class FruitSpel:
    ...
    def maak_fruit(self,scherm:list,kleur:tuple): # (  / 1)
        ...
        """
        self.fruiten.append(Fruit(scherm[0],scherm[1],kleur))
    ...
    def reset_kan_klikken(self,muis_ingedrukt:bool): # (  / 1)
        ...
        """
        if self.kan_klikken == False and muis_ingedrukt == False:
            self.kan_klikken == True
    ...
    def klikken(self,muis_ingedrukt:bool,muis_pos:tuple): # (  / 1)
        ...
        if muis_ingedrukt == True:
            ...
            self.raakt_fruiten(muis_pos=muis_pos)
